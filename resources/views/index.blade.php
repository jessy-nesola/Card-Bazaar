...
<body>
    ...
    <!-- Header/Navigation -->
    <nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="CardBazaar navigation bar">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-7">
                    <div class="hero-img-wrap">
                        <img src="/assets/images/cardhomepage.png" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
