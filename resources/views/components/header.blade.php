        ...
        <div class="row gx-5 align-items-center justify-content-center">
            <div class="col-lg-8 col-xl-7 col-xxl-6">
                <div class="my-5 text-center text-xl-start text-light">
                    <h1 class="fw-bold animate__animated animate__heartBeat">Benvenuto in CardBazaar.</h1>
                    <h4>Il tuo mondo, le tue carte!</h4>
                    <p>Qua puoi creare il tuo mazzo dei sogni.. Magia, Collezione, Azione!</p>
