...
<footer class="footer-section" style="margin-top: 50px;">
    <div class="container relative">
        ...
        <div class="row g-5 mb-5">
            <div class="col-lg-4">
                <div class="mb-4 footer-logo-wrap"><a href="#" class="footer-logo">CardBazaar<span>.</span></a>
                </div>
                <p class="mb-4">Cosa ci scriviamo qua? Cosa ci scriviamo qua? Cosa ci scriviamo qua? Cosa ci scriviamo qua? Cosa ci scriviamo qua? Cosa ci scriviamo qua? Cosa ci scriviamo qua?</p>
